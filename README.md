...
#### Запуск
Выполнить команду `./build/libs/intershop-v1.0.jar start`

#### Остановка
Выполнить команду `./build/libs/intershop-v1.0.jar stop`
...
> [!WARNING]
> Можно также запустить напрямую исполняемый jar-файл командой `./build/libs/intershop-v1.0.jar`, предварительно задав переменные среды
